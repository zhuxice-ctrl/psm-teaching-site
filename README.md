...
> 在原 Flask 工程之外新增了一套纯前端单页实现（`frontend-redesign/`，含 7 张 README 效果截图），原后端代码原样保留。
> **接手二次开发请先读 [`FRONTEND_REDESIGN.md`](FRONTEND_REDESIGN.md)**（背景 / 效果截图 / 设计系统 / 对接报告 / 开发入口 / 已知边界）。
